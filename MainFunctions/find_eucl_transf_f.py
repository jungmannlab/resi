...
folder_path = r'/Volumes/pool-miblab4/users/reinhardt/z_raw/Resi/211129_double-ext-20nm-2del-6sites-R4-single-site-ca/aligned/Rotation-test/alignment_locs/'
...
n_files = int(len(os.listdir(folder_path))/4)

# get all hdf5 file names in a list
for i in range(n_files):

    ch1_files.append('R1_apicked_ori' + str(i) + '_apicked.hdf5')
    ch3_files.append('R3_apicked_ori' + str(i) + '_apicked.hdf5')
